...
/**
 * packageName    : com.eosa.web.util.callmix.service
 * fileName       : Safety
 * author         : Jihun Kim
 * date           : 2022-09-16
 * description    :
...
public class Safety {
     ...
     */
    public Map<String, String> safetryEncode() throws NoSuchAlgorithmException {

        Map<String, String> map = new HashMap<>();

        com.eosa.admin.encode.SHA256 sha256 = new SHA256();
