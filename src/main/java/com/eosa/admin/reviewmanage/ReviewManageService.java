...
@Service
public class ReviewManageService implements ReviewManageRepository {

    @Autowired ReviewManageRepository reviewManageRepository;

    @Override
    public List<UsersReview> findAllUsersReview(int currentPageStartPost, int POST_COUNT) {
        return reviewManageRepository.findAllUsersReview(currentPageStartPost, POST_COUNT);
    }

    @Override
    public int findAllReviewCount() {
        return reviewManageRepository.findAllReviewCount();
    }
