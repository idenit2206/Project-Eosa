...
const _LOCAL_PREMIUM_SELECT = document.querySelector("#companysLocalPremium");
const _USERS_REGION1 = document.querySelector("#companysLocalPremiumRegion1");
const _USERS_REGION2 = document.querySelector("#companysLocalPremiumRegion2");

_LOCAL_PREMIUM_SELECT.addEventListener("change", (e) => {
    if(e.target.value == 0) {
        _USERS_REGION1.disabled = true;
        _USERS_REGION2.disabled = true;
    }
    else {
        _USERS_REGION1.removeAttribute("disabled");
        _USERS_REGION2.removeAttribute("disabled");
    }
})
